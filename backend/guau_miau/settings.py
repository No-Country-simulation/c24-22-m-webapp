"""
Django settings for guau_miau project.
...
SECRET_KEY = 'django-insecure-l7jjz)j09)j5s9hwd)dwz!tr4i6)la6u(18b+3qq^7a)l_3w16'
...
WSGI_APPLICATION = 'guau_miau.wsgi.application'
